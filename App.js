...
import { HomeScreen, SetPlayerDetailsScreen, DealerGameStartScreen, PlayerJoinGameScreen } from './app/Screens';
      ...
      <PlayerContextProvider>
        <NavigationContainer>
          <Stack.Navigator>
            ...
            <Stack.Screen name="GamePlayScreen" options={{headerShown: false}} component={GamePlayScreen} />
          </Stack.Navigator>
        </NavigationContainer>
      </PlayerContextProvider>
    );
